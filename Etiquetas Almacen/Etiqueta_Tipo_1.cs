...
namespace Etiquetas_Almacen
{
    class Etiqueta_Tipo_1 : Etiqueta
    {
        ...
        Image newImage = Image.FromFile("C:/Users/Juan/Desktop/Logos/PNG.png");
        ...
        private double getCenterXcoordinate(int etiquetaX, int textoX, int rectX)//anchura en pixeles del texto y de la etiqueta
        {
            double x = 0;
