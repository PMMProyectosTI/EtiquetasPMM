...
{
    class Etiqueta_Tipo_14_1 : Etiqueta
    {
        ...
        public Etiqueta_Tipo_14_1(string cp) : base(cp)
        {
        ...
        public PrintPageEventArgs dibujarEtiqueta(PrintPageEventArgs e, Etiqueta_Tipo_14_1 etq)
        {
            ...
            gfx.DrawString("CONSIGNATARIO:", letraDireccion, Brush, new Point(x, y));
            ...
            gfx.DrawString("ESTE PALLET", letraCampos, Brush, new Point(x, y));
            y += 18;
            gfx.DrawString("CONTIENE:", letraCampos, Brush, new Point(x, y));
            gfx.DrawString(etq.Contenido, letraCampos, Brush, new Point(x + 300, y));
            y += 35;
            gfx.DrawString("CLAVE DE", letraCampos, Brush, new Point(x, y));
            y += 18;
            ...
            y += 35;
            gfx.DrawString("ORDEN DE", letraCampos, Brush, new Point(x, y));
            y += 18;
            gfx.DrawString("COMPRA:", letraCampos, Brush, new Point(x, y));
            ...
            y += 35;
            gfx.DrawString("LARGO DE", letraCampos, Brush, new Point(x, y));
            y += 18;
            gfx.DrawString("CORTE:", letraCampos, Brush, new Point(x, y));
            ...
            x = rect_lateral_derecho_sup.X + 66;
