...
namespace Etiquetas_Almacen
{
    class Etiqueta_Tipo_3_1 : Etiqueta
    {
        ...
        public Etiqueta_Tipo_3_1(string cp)
            : base(cp)
        {
        ...
        public PrintPageEventArgs dibujarEtiqueta(PrintPageEventArgs e, Etiqueta_Tipo_3_1 etq)
        {
            ...
            while (cont <= 2)
            {
                ...
                Rectangle rect_superior_2 = new Rectangle(x, rect_superior.Y + rect_superior.Height, etq.Ancho, 39);
                Rectangle rect_lateral_izquierdo = new Rectangle(x, rect_superior_2.Y + rect_superior_2.Height, 372, 174);
                Rectangle rect_lateral_derecho_1 = new Rectangle(rect_lateral_izquierdo.X + rect_lateral_izquierdo.Width, rect_superior_2.Y + rect_superior_2.Height, 379, 69);
                Rectangle rect_lateral_derecho_2 = new Rectangle(rect_lateral_izquierdo.X + rect_lateral_izquierdo.Width, rect_lateral_derecho_1.Y + rect_lateral_derecho_1.Height, 379, 56);
                Rectangle rect_lateral_derecho_3 = new Rectangle(rect_lateral_izquierdo.X + rect_lateral_izquierdo.Width, rect_lateral_derecho_2.Y + rect_lateral_derecho_2.Height, 379, 49);
                ...
                //Imágenes
                gfx.DrawImage(etq.LogoPMM, rectangulo_contorno.X + 4, rectangulo_contorno.Y + 5/2, 366, 83);
                gfx.DrawImage(etq.ISO9001, 582, rectangulo_contorno.Y + 4, rect_superior.Height - 8, rect_superior.Height - 11);
                gfx.DrawImage(etq.ISO14001, 686, rectangulo_contorno.Y + 4, rect_superior.Height - 8, rect_superior.Height - 11);
